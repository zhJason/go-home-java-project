...
public class Constants {
	...
	"<p style=\"text-align:left;\">当前版本：典藏版 v2.0&nbsp;&nbsp;&nbsp;发布日期：2012.01.15</strong></p>"+
	...
	"<p style=\"text-align:left;\">作者：<em><a> cafebabe </a></em>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Email：<em>talentyao@foxmail.com</em>"+
	"<p style=\"text-align:left;\">特别感谢：<em>vivia ,</em><em> uniqguang </em></p>"+
	"<p style=\"text-align:left;\">部分贡献者名单：<em>yixiangxiang ,</em><em> childlikeman ,</em><em> oyzcha </em></p>"+
...
//	public static String startDate; // 乘车时间
...
//	public static byte isAUTOCODE = false;
	...
	public final static String USER_SUCC_INFO="您最后一次登录时间为";
